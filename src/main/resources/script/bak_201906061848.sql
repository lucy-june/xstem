...
CREATE SEQUENCE "ss1604c195_rd2"."recruit_applyment_applymentid_seq"
 ...
 START 666716
 CACHE 1;
SELECT setval('"ss1604c195_rd2"."recruit_applyment_applymentid_seq"', 666716, true);
...
CREATE SEQUENCE "ss1604c195_rd2"."recruit_applyment_log_id_seq"
 ...
 START 201
 CACHE 1;
SELECT setval('"ss1604c195_rd2"."recruit_applyment_log_id_seq"', 201, true);
...
INSERT INTO "ss1604c195_rd2"."recruit_applyment" VALUES ('1', '1', '1', '1', '2016-06-06 17:59:29.741', '2016-06-06 17:59:29.741', '666716');
